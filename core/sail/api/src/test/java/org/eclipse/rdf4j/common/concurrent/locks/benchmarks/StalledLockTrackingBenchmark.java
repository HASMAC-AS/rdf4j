...
public class StalledLockTrackingBenchmark extends ReadWriteLockManagerBenchmark {

	public static void main(String[] args) throws RunnerException {
		Options opt = new OptionsBuilder()
				.include("benchmarks.StalledLockTrackingBenchmark.*") // adapt to run other benchmark tests
				.build();
