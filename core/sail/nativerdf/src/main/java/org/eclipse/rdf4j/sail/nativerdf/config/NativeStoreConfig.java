...
import static org.eclipse.rdf4j.sail.nativerdf.config.NativeStoreSchema.MEMORY_MAPPED_TXN_STATUS_FILE;
...
public class NativeStoreConfig extends BaseSailConfig {
	...
	private Boolean memoryMappedTxnStatusFile;
	...
	public Boolean getMemoryMappedTxnStatusFile() {
		return memoryMappedTxnStatusFile;
	}

	public void setMemoryMappedTxnStatusFile(boolean memoryMappedTxnStatusFile) {
		this.memoryMappedTxnStatusFile = memoryMappedTxnStatusFile;
	}
	...
	public Resource export(Model m) {
		...
		if (memoryMappedTxnStatusFile != null) {
			m.add(implNode, CONFIG.Native.memoryMappedTxnStatusFile, literal(memoryMappedTxnStatusFile));
		}
	...
	private Resource exportLegacy(Model m) {
		...
		if (memoryMappedTxnStatusFile != null) {
			m.add(implNode, MEMORY_MAPPED_TXN_STATUS_FILE, literal(memoryMappedTxnStatusFile));
		}
	...
	public void parse(Model m, Resource implNode) throws SailConfigException {
		...
		try {
			...
			Configurations.getLiteralValue(m, implNode, CONFIG.Native.memoryMappedTxnStatusFile,
					MEMORY_MAPPED_TXN_STATUS_FILE)
					.ifPresent(lit -> {
						try {
							setMemoryMappedTxnStatusFile(lit.booleanValue());
						} catch (IllegalArgumentException e) {
							throw new SailConfigException(
									"Boolean value required for " + CONFIG.Native.memoryMappedTxnStatusFile
											+ " property, found " + lit);
						}
					});
