...
public class NativeStoreSchema {
	...
	/**
	 * <var>http://www.openrdf.org/config/sail/native#memoryMappedTxnStatusFile</var>
	 *
	 * @deprecated use {@link CONFIG.Native#memoryMappedTxnStatusFile} instead.
	 */
	public final static IRI MEMORY_MAPPED_TXN_STATUS_FILE;
	...
	static {
		...
		MEMORY_MAPPED_TXN_STATUS_FILE = factory.createIRI(NAMESPACE, "memoryMappedTxnStatusFile");
	}
}
