...
import org.eclipse.rdf4j.query.algebra.helpers.AbstractQueryModelNode;
...
@Override
public List<String> getAssuredBindingNames() {
return new ArrayList<>(assuredBindingNames);
}
...
@Override
public List<? extends QueryModelNode> getChildren() {
return patterns;
}

@Override
public boolean replaceChildNode(QueryModelNode current, QueryModelNode replacement) {
