...
/**
 * Represents a single quad component inside a {@link QuadPattern}. The component is either a constant term id, a named
 * query variable, or an unbound wildcard slot.
 */
